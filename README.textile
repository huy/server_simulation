...
the servers are occupied then next incomming request has to wait until one of them become available.
...
This decribe a degree the service time spreads from mean time
